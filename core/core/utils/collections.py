def deep_update(base_dict: dict, update_with):
    ...
    for key, value in update_with.items():
        ...
        if isinstance(value, dict):
            ...
            # If the original value is not a dict then just set the value
            else:
                base_dict[key] = value
        # If the value is not a dict then just set the value
        else:
            base_dict[key] = value
